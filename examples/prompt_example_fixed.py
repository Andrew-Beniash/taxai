...
This version properly handles device placement to avoid warnings.
"""
...
from core_ai_engine.prompt_engineering import generate_tax_law_response, create_tax_query_prompt, format_ai_response_with_citations
...
def main():
    ...
    # Generate response using our prompt engineering with proper device handling
    print("Generating AI response...")
    try:
        response = generate_tax_law_response_with_device(user_query, context_docs, model, tokenizer)
